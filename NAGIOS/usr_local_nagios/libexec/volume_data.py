...
###SSH ACCOUNT TO USE. Ensure it is set up with rbash and limited to executing sudo xfs_growfs and/or sudo resize2fs
ssh_account = 'username'


###DIGITAL OCEAN###

DIGITALOCEAN_1_IP = '0.0.0.0'  #the servers' ips
DIGITALOCEAN_2_IP = '0.0.0.1'
